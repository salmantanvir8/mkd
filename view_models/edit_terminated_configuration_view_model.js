...
module.exports = function (entity, pageName = "", success, error, base_url = "") {
  ...
  this.endpoint = "/admin/terminate_configuration";
  ...
  this.heading = "Edit Terminate Configuration";

  this.action = "/admin/terminate_configuration-edit";

  this.form_fields = { message: "", id: "", header_text: "", counter: "" };
