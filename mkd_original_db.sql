...
DROP TABLE IF EXISTS `terminate_configuration`;



CREATE TABLE IF NOT EXISTS `terminate_configuration` (
...
DELETE FROM `terminate_configuration`;


INSERT INTO `terminate_configuration` (`id`, `counter`, `message`, `header_text`, `created_at`, `updated_at`) VALUES (1, 10, , 'You have allergy to one of the main ingredients in our system ','Quiz now will be terminated', '2022-04-10 11:07:44', '2022-04-10 11:07:44')
